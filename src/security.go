...
func NASEncode(ue *RanUeContext, msg *nas.Message, securityContextAvailable bool, newSecurityContext bool) (
	...
	if !securityContextAvailable {
		...
		fmt.Println("MAC value========================")
		fmt.Println(ue.IntegrityAlg)
		fmt.Println(ue.KnasInt)
		fmt.Println(ue.ULCount.Get())
		fmt.Println(security.Bearer3GPP)
		fmt.Println(security.DirectionUplink)
